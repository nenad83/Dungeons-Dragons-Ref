...
export class AdndClasseDetails extends React.Component {
        ...
        return(
            ...
            <div className="adndclass-detail">
                        ...
                        <div>
                            ...
                            <h4>Requirements: {this.state.class.Primary_Ability}</h4>
                            <h4>Multi-class: {this.state.class.Multi_class}</h4>
                            <h4>Dual-class: {this.state.class.Dual_class}</h4>
                            ...
                            <h4>Max Proficiency Allowed: {this.state.class.Max_Proficiency_Allowed}</h4>
                            <h4>Spells: {this.state.class.Spells}</h4>
                            <h4>Class Abilities: {this.state.class.Class_Abilities}</h4>
                            <h4>Attacks per level: {this.state.class.Attacks_per_level}</h4>
                            <h4>Lore: {this.state.class.Lore}</h4>
                        </div>
                        <table border="1">
                            <thead>
                                <tr>
                        ...
                        <br/>
                        <h6>Description: {this.state.class.Text}</h6>
